...
export async function getStaticProps() {
  return {
    props: {
      page: await fetchSinglePage(325),
    },
    revalidate: 10,
  }
}
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Associazione Proprietà Edilizia
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Associazione Proprietà
              Edilizia, accessible from{" "}
              <a
