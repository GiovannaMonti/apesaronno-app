...
export async function getStaticProps() {
  return {
    props: {
      page: await fetchSinglePage(323),
    },
    revalidate: 10,
  }
}

export default function CookiePolicy({ page }) {
  return (
    <>
      <Menu />
      <div className="p-policy">
        <Head>
          ...
          <meta
            name="description"
            content="Consulta la cookie policy di Associazione proprietà edilizia. Dal 1973 al fianco dei proprietari di case."
          />
        ...
        <ul>
          <li>
            ...
            this Cookies Policy) refers to Associazione Proprietà Edilizia
            Saronno, Via Parini 54, Saronno, 21047.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Associazione Proprietà Edilizia,
            accessible from{" "}
            <a
              href="https://www.apesaronno.it"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.apesaronno.it
            </a>
          </li>
          <li>
        ...
        <ul>
          <li>By email: apesaronnoinfo@gmail.com</li>
        </ul>
      </div>
      <Footer page={page} />
    </>
